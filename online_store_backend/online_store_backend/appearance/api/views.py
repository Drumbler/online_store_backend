...
class ShopAppearancePublicView(APIView):
    ...
    def get(self, request):
        payload = public_appearance_payload()
...
class AdminAppearanceDraftView(APIView):
    ...
    def get(self, request):
        ...
        return Response(serialize_settings(draft), status=status.HTTP_200_OK)
    ...
    def put(self, request):
        ...
        return Response(serialize_settings(refreshed), status=status.HTTP_200_OK)
...
class AdminAppearanceResetView(APIView):
    ...
    def post(self, request):
        ...
        draft = get_scope_settings(is_published=False)
        return Response({"ok": True, "draft": serialize_settings(draft)}, status=status.HTTP_200_OK)
