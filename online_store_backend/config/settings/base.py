...
APPS_DIR = BASE_DIR / "online_store_backend"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "online_store_backend.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "online_store_backend.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Drumbler""", "support@localhost")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "online_store_backend.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "online_store_backend.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "online_store_backend.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "online_store_backend.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Online Store Backend API",
    "DESCRIPTION": "Documentation of API endpoints of Online Store Backend",
    "VERSION": "1.0.0",
...
SHIPPING_WEBHOOK_SHARED_SECRET = env("SHIPPING_WEBHOOK_SHARED_SECRET", default="")
